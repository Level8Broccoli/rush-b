...
| T05  | Erstimplementierung Gameplay (Navigation, Gravitation, Collision Detection)  | M2 | Lena | ![0%](https://progress-bar.dev/0) |
| T05  | Erstimplementierung UI (Game)                                | M2 | Oli | ![0%](https://progress-bar.dev/0) |
| T05  | Erstimplementierung Schnittstellen (Game)                    | M2 | Oli & Lena | ![0%](https://progress-bar.dev/0) |
| T04  | Dokumentation Meilenstein 2                                  | M2 | Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Erweiterung Gameplay (Spielerinteraktion, Timer, Malen)      | M3 | Lena | ![0%](https://progress-bar.dev/0) |
| T05  | Erweiterung UI (Fancy Design, Lobby)                         | M3 | Oli | ![0%](https://progress-bar.dev/0) |
| T05  | Erweiterung UI (Avatare, Sprite Sheets)                      | M3 | Lena | ![0%](https://progress-bar.dev/0) |
| T05  | Erweiterung Gameplay (Lobby)                                 | M3 | Oli & Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Erweiterung Schnittstellen                                   | M3 | Oli & Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Unit Tests                                                   | M3 | Oli & Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Implementierung KI                                           | M3 | Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Training KI                                                  | M3 | Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Evaluation KI                                                | M3 | Lena | ![0%](https://progress-bar.dev/0) |
| T04  | Dokumentation Meilenstein 3                                  | M3 | Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Features (Optional)                                          | M4 | Oli & Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Dockerisierung (Optional)                                    | M4 | Oli | ![0%](https://progress-bar.dev/0) |
| T06  | Dokumentation Quellcode Backend                              | M4 | Lena | ![0%](https://progress-bar.dev/0) |
| T06  | Dokumentation Quellcode Frontend                             | M4 | Oli | ![0%](https://progress-bar.dev/0) |
| T06  | Schlusspräsentation                                          | M4 | Oli & Lena | ![0%](https://progress-bar.dev/0) |
| T04  | Dokumentation Meilenstein 4                                  | M4 | Lena | ![0%](https://progress-bar.dev/0) |
...
Dafür wird eine eigene [Library](https://github.com/lpapailiou/neuralnetwork) als Plug-In eingesetzt, die bei Bedarf.  
