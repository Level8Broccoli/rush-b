...
Backend: Mit dem Dazukommen von NPC's wurde mit Vererbung experimentiert. Das Design erscheint unpassend. Im weiteren Verlauf des
Projektes werden wir voraussichtlich versuchen mit Kompositionen zu arbeiten.
Frontend: Mit der Einführung von Sprites ist auf dem UI ein Flackern der Figuren zu beobachten. Effizienteres Laden der
Sprites wird folglich in einem nächsten Schritt angegangen.
